...
from routes.course.schemas import UserCourse
...
def get_user_course(course_id: int, member=Depends(validate_course_membership)):
    db = create_supabase_client()
    ...
    return UserCourse(course=course, role=member.role)
